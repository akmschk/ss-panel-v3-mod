...
<li>
                            ...
                            <li><a href="http://123y.speedtestcustom.com"  target="_black"><i class="icon icon-lg">import_export</i>&nbsp;网速测试</a></li>
							<li>
								<a href="/user/edit">
							...
							<li>
								<a href="/user/donate">
									<i class="icon icon-lg">attach_money</i>&nbsp;众筹明细
								</a>
							</li>
						...
						<li> <a href="/admin/alive"> <i class="icon icon-lg">important_devices</i>&nbsp;在线IP</a></li>
                  		                <li><a href="/admin"><i class="icon icon-lg">person_pin</i>&nbsp;管理面板</a></li>
