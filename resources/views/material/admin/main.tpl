	...
	<nav aria-hidden="true" class="menu menu-left nav-drawer nav-drawer-md" id="ui_menu" tabindex="-1">
		<div class="menu-scroll">
			<div class="menu-content">
				...
				<ul class="nav">
					<li>
						<a class="waves-attach" data-toggle="collapse" href="#ui_menu_me">常用</a>
						<ul class="menu-collapse collapse in" id="ui_menu_me">
							...
							<li><a href="/admin/code"><i class="icon icon-lg">code</i>&nbsp;捐赠{if $config['enable_donate']=='true'}支出{/if}</a></li>
							<li><a href="/admin/alive"><i class="icon icon-lg">important_devices</i>&nbsp;在线IP</a></li>
						</ul>


						<a class="waves-attach" data-toggle="collapse" href="#ui_menu_detect">其它</a>
